...
INSERT INTO "new_JobOrder" ("balanceFils", "costFils", "createdAt", "customerId", "deliveredAt", "dueDate", "fabricSource", "id", "invoiceId", "invoiceItemId", "isPaid", "jobNo", "measurementId", "measurements", "notes", "paidFils", "priority", "productId", "productStyle", "stage", "totalFils", "updatedAt") SELECT "balanceFils", "costFils", "createdAt", "customerId", "deliveredAt", "dueDate", "fabricSource", "id", "invoiceId", "invoiceItemId", "isPaid", "jobNo", "measurementId", "measurements", "notes", "paidFils", "priority", "productId", "productStyle", "stage", "totalFils", "updatedAt" FROM "JobOrder";
DROP TABLE "JobOrder";
