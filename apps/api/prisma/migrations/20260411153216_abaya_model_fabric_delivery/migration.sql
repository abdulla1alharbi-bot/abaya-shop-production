...
INSERT INTO "new_AbayaModel" ("abayaTypeId", "code", "cuttingWageFils", "defaultPriceFils", "description", "embroideryWageFils", "finishingWageFils", "id", "isActive", "name", "productId", "sewingWageFils", "sortOrder") SELECT "abayaTypeId", "code", "cuttingWageFils", "defaultPriceFils", "description", "embroideryWageFils", "finishingWageFils", "id", "isActive", "name", "productId", "sewingWageFils", "sortOrder" FROM "AbayaModel";
